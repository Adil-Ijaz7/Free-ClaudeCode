...
def _settings(
    *,
    model: str = "open_router/deepseek/deepseek-chat",
    model_opus: str | None = "open_router/anthropic/claude-opus",
    model_haiku: str | None = "open_router/deepseek/deepseek-chat",
) -> Settings:
...
def test_models_list_includes_configured_refs_cached_provider_models_and_aliases():
    ...
    registry.cache_model_ids(
        "open_router",
        {"deepseek/deepseek-chat", "meta/llama-3.3", "anthropic/claude-opus"},
    )
    ...
    assert ids[:6] == [
        "anthropic/open_router/deepseek/deepseek-chat",
    ...
    assert ids.count("anthropic/open_router/deepseek/deepseek-chat") == 1
    assert (
        ids.count("claude-3-freecc-no-thinking/open_router/deepseek/deepseek-chat") == 1
    )
